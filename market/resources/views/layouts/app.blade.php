...
<head>
    ...
    <title>@yield('title', 'JT Store')</title>
    ...
    <!-- estilos del slider pagina principal -->
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navigation-example">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="https://www.facebook.com/holasoyjuandi" target="_blank" class="btn btn-simple btn-white btn-just-icon">
